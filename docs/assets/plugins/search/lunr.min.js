...
!(function () {
  ...
  (e.version = '2.3.9'),
    ...
    (e.Vector.prototype.positionForIndex = function (e) {
      ...
      for (var t = 0, r = this.elements.length / 2, i = r - t, n = Math.floor(i / 2), s = this.elements[2 * n]; i > 1 && (s < e && (t = n), s > e && (r = n), s != e); )
    ...
    (e.Vector.prototype.dot = function (e) {
      for (var t = 0, r = this.elements, i = e.elements, n = r.length, s = i.length, o = 0, a = 0, u = 0, l = 0; u < n && l < s; )
        (o = r[u]), (a = i[l]), o < a ? (u += 2) : o > a ? (l += 2) : o == a && ((t += r[u + 1] * i[l + 1]), (u += 2), (l += 2));
      return t;
    }),
    ...
    (e.stemmer = (function () {
      var e = {
        ...
        I = function (r) {
          ...
          if (((s = r.substr(0, 1)), 'y' == s && (r = s.toUpperCase() + r.substr(1)), (o = p), (a = y), o.test(r) ? (r = r.replace(o, '$1$2')) : a.test(r) && (r = r.replace(a, '$1$2')), (o = m), (a = v), o.test(r))) {
            var I = o.exec(r);
            (o = c), o.test(I[1]) && ((o = g), (r = r.replace(o, '')));
          } else if (a.test(r)) {
            var I = a.exec(r);
            (i = I[1]), (a = f), a.test(i) && ((r = i), (a = x), (u = w), (l = Q), a.test(r) ? (r += 'e') : u.test(r) ? ((o = g), (r = r.replace(o, ''))) : l.test(r) && (r += 'e'));
          }
          if (((o = k), o.test(r))) {
            var I = o.exec(r);
            (i = I[1]), (r = i + 'i');
          ...
          return (o = T), (a = h), o.test(r) && a.test(r) && ((o = g), (r = r.replace(o, ''))), 'y' == s && (r = s.toLowerCase() + r.substr(1)), r;
        };
      return function (e) {
        return e.update(I);
      };
    ...
    (e.TokenSet.fromFuzzyString = function (t, r) {
      for (var i = new e.TokenSet(), n = [{ node: i, editsRemaining: r, str: t }]; n.length; ) {
        ...
        if (s.str.length > 0) {
          var o,
            a = s.str.charAt(0);
          a in s.node.edges ? (o = s.node.edges[a]) : ((o = new e.TokenSet()), (s.node.edges[a] = o)), 1 == s.str.length && (o['final'] = !0), n.push({ node: o, editsRemaining: s.editsRemaining, str: s.str.slice(1) });
        }
        if (0 != s.editsRemaining) {
          ...
          if (
            ...
            1 == s.str.length && (l['final'] = !0), n.push({ node: l, editsRemaining: s.editsRemaining - 1, str: s.str.slice(1) });
          }
          if (s.str.length > 1) {
            var c,
              h = s.str.charAt(0),
          ...
          for (var c = s[l], h = 0; h < u; h++) {
            ...
            if (d == c || '*' == c) {
              var f = i.node.edges[d],
                ...
                y = f['final'] && p['final'],
                m = void 0;
              d in i.output.edges ? ((m = i.output.edges[d]), (m['final'] = m['final'] || y)) : ((m = new e.TokenSet()), (m['final'] = y), (i.output.edges[d] = m)), n.push({ qNode: p, output: m, node: f });
            }
          }
      }
      return r;
        ...
        for (var f = 0; f < c.length; f++) {
          ...
          for (var v = 0; v < this.metadataWhitelist.length; v++) {
            var g = this.metadataWhitelist[v],
              x = p.metadata[g];
            void 0 == this.invertedIndex[p][o][i][g] && (this.invertedIndex[p][o][i][g] = []), this.invertedIndex[p][o][i][g].push(x);
          }
        }
      }
    }),
      ...
      for (var t = {}, r = Object.keys(this.fieldTermFrequencies), i = r.length, n = Object.create(null), s = 0; s < i; s++) {
        for (
          ...
          void 0 === n[x] ? ((m = e.idf(this.invertedIndex[x], this.documentCount)), (n[x] = m)) : (m = n[x]),
            (v = (m * ((this._k1 + 1) * w)) / (this._k1 * (1 - this._b + this._b * (u / this.averageFieldLength[a])) + w)),
            (v *= f),
            (v *= p),
